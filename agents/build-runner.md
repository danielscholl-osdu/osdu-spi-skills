---
name: build-runner
description: "Execute build/test commands and return structured summaries. Spawned by @osdu to run Maven builds in isolation, keeping the main context clean from 5000+ lines of build output."
---
