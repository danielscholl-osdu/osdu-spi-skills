---
name: qa-reporter
description: Generate professional QA reports from OSDU test results. Use after running tests to create HTML dashboards, Markdown reports, or executive summaries.
---
