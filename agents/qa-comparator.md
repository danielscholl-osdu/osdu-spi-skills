---
name: qa-comparator
description: Compare OSDU test results across multiple environments. Use when validating feature branches, comparing staging to production, or detecting regressions.
---
